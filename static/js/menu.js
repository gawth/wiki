...
/* Rainbow v2.1.2 rainbowco.de | included languages: c, csharp, css, generic, html, java, javascript, json, php, python, ruby */
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.Rainbow = t() }(this, function() {
    "use strict";
    ...
    function u(e) { var t = []; for (var n in e) e.hasOwnProperty(n) && t.push(n); return t.sort(function(e, t) { return t - e }) }

    function c(e, t, n, r) { var a = r.substr(e); return r.substr(0, e) + a.replace(t, n) }
    ...
    function s(t, n) {
        ...
        var g = f + "\tthis.onmessage =" + d,
            m = new Blob([g], { type: "text/javascript" });
    ...
    function l() { return (R || null === j) && (j = s(f, C)), j }
    ...
    function g(e, t, n) { return function(r) { e.innerHTML = r.result, e.classList.remove("loading"), "PRE" === e.parentNode.tagName && e.parentNode.classList.remove("loading"), M && M(e, r.lang), 0 === --t.c && n() } }

    function m(e) { return { patterns: S, inheritenceMap: T, aliases: x, globalClass: e.globalClass, delay: isNaN(e.delay) ? 0 : e.delay } }

    function v(e, t) { var n = {}; "object" == typeof t && (n = t, t = n.language), t = x[t] || t; var r = { id: String.fromCharCode(65 + Math.floor(26 * Math.random())) + Date.now(), code: e, lang: t, options: m(n), isNode: R }; return r }
    ...
    function y(e, t, n) { T[e] || (T[e] = n), S[e] = t.concat(S[e] || []) }

    function N(e) { delete T[e], delete S[e] }

    function L() { for (var e = [], t = arguments.length; t--;) e[t] = arguments[t]; if ("string" == typeof e[0]) { var n = v(e[0], e[1]); return void d(n, function(e) { return function(t) { e && e(t.result, t.lang) } }(e[2])) } return "function" == typeof e[0] ? void b(0, e[0]) : void b(e[0], e[1]) }

    function E(e, t) { x[e] = t }
    var M, C = function H(e) {
            ...
            function f(e) { var t = ""; return e.ignoreCase && (t += "i"), e.multiline && (t += "m"), new RegExp(e.source, t) }

            function l(r, a, i) {
                function s(e) { return r.name && (e = n(r.name, e)), p[w] = { replace: m[0], "with": e }, h[w] = y, !g && { remaining: a.substr(y - i), offset: y } }
                ...
                function l(t) {
                    ...
                    if (a) {
                        var i = r.matches[t],
                            ...
                            f = function(e, r, a) { b = c(o(m, t), e, a ? n(a, r) : r, b) };
    ...
    }), R || k || document.addEventListener("DOMContentLoaded", function(e) { A.defer || A.color(e) }, !1), k && (self.onmessage = f);
    var B = A;
    return B
});
